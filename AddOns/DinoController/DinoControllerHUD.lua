...
local function CreateHUDButton(parent, slotInfo, index)
    ...
    btn.UpdateDisplay = function(self)
        ...
        if self.dinoSlotInfo.id == 7 then
            -- A-Taste: ausgewaehlte Primaeraktion / Interact
    ...
    btn:SetScript("OnClick", function()
        ...
        if this.dinoSlotInfo.id == 7 then
            ...
            GameTooltip:SetText((actionInfo and actionInfo.label or "Melee") .. " / Interact", 1.0, 1.0, 1.0)
            GameTooltip:Show()
            return
        end
    ...
    btn:SetScript("OnEnter", function()
        if this.dinoSlotInfo.id == 8 then
            ...
            GameTooltip:AddLine("Targets your character.", 0.8, 0.8, 0.8, 1)
            GameTooltip:Show()
            return
        end
...
function DinoHUD_Unlock()
    ...
    UpdateHUDLockState()
    HUDPrint("HUD unlocked - movement and drag-and-drop enabled.")
end
