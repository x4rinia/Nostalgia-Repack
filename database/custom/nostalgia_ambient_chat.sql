...
(215, 'General', 900123, 'Totemtrude', 6, 1, 7, 'wailing caverns 10er suche noch 3'),
...
(130, 'General', 900126, 'Seuchenzahn', 5, 0, 4, 'sfk 10er lfm tank und heal'),
...
(14, 'General', 900129, 'Kriegsgurke', 2, 0, 9, 'lfm rfk 10er need 2 dd'),
...
(331, 'General', 900132, 'Voodoomaus', 8, 1, 8, 'zulfarrak 10er lfm bitte keine leaver'),
